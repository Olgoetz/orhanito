    ...
    <>
      ...
      >
        ...
        <div className="mt-4 text-sm text-justify">
          <p>
            We are very delighted that you have shown interest in my duties.
            Data protection is of a particularly high priority for md. The use
            of the Internet pages is possible without any indication of personal
          ...
          <p>
            ...
            applicable to the this site. By means of this data protection
          ...
          <p>
            As the controller, I have implemented numerous technical and
          ...
          <h4 className="font-bold my-4">1. Definitions</h4>
          <p>
            The data protection declaration of this site is based on the terms
          ...
          <ul style={{ listStyle: "none" }}>
            <li>
              <h4 className="font-bold my-4">a)    Personal data</h4>
              <p>
            ...
            <li>
              <h4 className="font-bold my-4">b)    Data subject</h4>
              <p>
            ...
            <li>
              <h4 className="font-bold my-4">c)    Processing</h4>
              <p>
            ...
            <li>
              <h4 className="font-bold my-4">e)    Profiling</h4>
              <p>
            ...
            <li>
              <h4 className="font-bold my-4">f)     Pseudonymisation</h4>
              <p>
            ...
            <li>
              <h4 className="font-bold my-4">h)    Processor</h4>
              <p>
            ...
            <li>
              <h4 className="font-bold my-4">i)      Recipient</h4>
              <p>
            ...
            <li>
              <h4 className="font-bold my-4">j)      Third party</h4>
              <p>
          ...
          <p>
            This website collects a series of general data and information when
            ...
            Internet site, (6) an Internet protocol address (IP address), (7)
          ...
          <p>
            When using these general data and information, the I do not not draw
            ...
            in case of a cyber-attack. Therefore, the page analyzes anonymously
          ...
          <p>
            This contains information that enables a quick electronic contact to
            our enterprise, as well as direct communication with us, which also
            ...
            are automatically stored. Such personal data transmitted on a
          ...
          <h4 className="font-bold my-4">6. Rights of the data subject</h4>
          <ul style={{ listStyle: "none" }}>
            <li>
              <h4 className="font-bold my-4">a) Right of confirmation</h4>
              <p>
            ...
            <li>
              <h4 className="font-bold my-4">b) Right of access</h4>
              <p>
                Each data subject shall have the right granted by the European
            ...
            <li>
              <h4 className="font-bold my-4">c) Right to rectification </h4>
              <p>
                Each data subject shall have the right granted by the European
            ...
            <li>
              ...
              <p>
                ...
                website, he or she may, at any time, contact any employee of the
                controller. I shall promptly ensure that the erasure request is
              ...
              <p>
                ...
                those personal data, as far as processing is not required. I
            ...
            <li>
              ...
              <p>
                ...
                personal data stored by this wbsite, he or she may at any time
                contact any employee of the controller. The employee will
                arrange the restriction of the processing.{" "}
              </p>
            </li>
            <li>
              <h4 className="font-bold my-4">f) Right to data portability</h4>
              <p>
                Each data subject shall have the right granted by the European
              ...
              <p>
                ...
                subject may at any time contact me.
              </p>
            </li>
            <li>
              <h4 className="font-bold my-4">g) Right to object</h4>
              <p>
                Each data subject shall have the right granted by the European
              ...
              <p>
                I shall no longer process the personal data in the event of the
                objection, unless we can demonstrate compelling legitimate
              ...
              <p>
                If this page processes personal data for direct marketing
                ...
                to the processing for direct marketing purposes, I will no
              ...
              <p>
                ...
                personal data concerning him or her by this site for scientific
              ...
              <p>
                ...
                contact me. In addition, the data subject is free in the context
            ...
            <li>
              ...
              <p>
                ...
                explicit consent, this website shall implement suitable measures
            ...
            <li>
              ...
              <p>
                ...
                consent, he or she may, at any time, contact me.
              </p>
            </li>
          </ul>
          <h4 className="font-bold my-4">
          ...
          <p>
            ...
            service Instagram. Instagram is a service that may be qualified as
            an audiovisual platform, which allows users to share photos and
          ...
          <p>
            ...
            This occurs regardless of whether the person clicks on the Instagram
          ...
          <h4 className="font-bold my-4">8. Legal basis for the processing </h4>
          <p>
